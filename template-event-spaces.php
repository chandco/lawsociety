    ...
    <?php
	 ...
	 ?>
        ...
        <li>
          ...
          <a href="<?php echo get_page_link( $page->ID ); ?>" class="room-img"><?php echo get_the_post_thumbnail($page->ID, 'post-thumbnail-rect'); ?></a>

          <div class="event-rooms-excerpt">

           <h5><a href="<?php echo get_page_link( $page->ID ); ?>"><?php echo $page->post_title; ?></a></h5>

           <p><?php echo wp_trim_words( $content, 10 ); ?></p>
